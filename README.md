...
<ul style='font-size: 20px; margin-left:100px;'>
    ...
    <li> Trending AI technologies, tools and resources for coding. </li>
    <li> Best practices in software development and software testing.</li>
 </ul>
...
<ul style='font-size: 20px; margin-left:100px;'>
  ...
  <li> Willingness to learn and research about various software development topics. </li>
  <li> Skills in software development and testing is a bonus. </li>
</ul>
...
2. **Onboarding Starts:** Get onboard with us, learn about Keploy's ecosystem, connect with the team & mentors on [slack](https://keploy.slack.com/join/shared_invite/zt-357qqm9b5-PbZRVu3Yt2rJIa6ofrwWNg#/shared-invite/email).
...
4. **Craft your Work:** Start crafting your ideas into words. This part includes you working on the approved ideas and topics, writing blog drafts on the topic, creating short social media carousels on the same.
